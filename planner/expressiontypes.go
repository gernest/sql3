...
// takes a *api.FieldInfo and returns a sql data type
func fieldSQLDataType(f *api.FieldInfo) parser.ExprDataType {
	...
	// `api.FieldTypeID` to compare against. One option would have been to
