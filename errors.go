...
var (
	...
	ErrCacheKeyNotFound = errors.New("(ErrCacheKeyNotFound")

	// syntax/semantic errors
	ErrDuplicateColumn       = errors.New("(ErrDuplicateColumn")
	ErrUnknownType           = errors.New("(ErrUnknownType")
	ErrUnknownIdentifier     = errors.New("(ErrUnknownIdentifier")
	ErrTopLimitCannotCoexist = errors.New("(ErrTopLimitCannotCoexist")

	// type related errors
	ErrTypeIncompatibleWithBitwiseOperator               = errors.New("(ErrTypeIncompatibleWithBitwiseOperator")
	ErrTypeIncompatibleWithLogicalOperator               = errors.New("(ErrTypeIncompatibleWithLogicalOperator")
	ErrTypeIncompatibleWithEqualityOperator              = errors.New("(ErrTypeIncompatibleWithEqualityOperator")
	ErrTypeIncompatibleWithComparisonOperator            = errors.New("(ErrTypeIncompatibleWithComparisonOperator")
	ErrTypeIncompatibleWithArithmeticOperator            = errors.New("(ErrTypeIncompatibleWithArithmeticOperator")
	ErrTypeIncompatibleWithConcatOperator                = errors.New("(ErrTypeIncompatibleWithConcatOperator")
	ErrTypeIncompatibleWithLikeOperator                  = errors.New("(ErrTypeIncompatibleWithLikeOperator")
	ErrTypeIncompatibleWithBetweenOperator               = errors.New("(ErrTypeIncompatibleWithBetweenOperator")
	ErrTypeCannotBeUsedAsRangeSubscript                  = errors.New("(ErrTypeCannotBeUsedAsRangeSubscript")
	ErrTypesAreNotEquatable                              = errors.New("(ErrTypesAreNotEquatable")
	ErrTypeMismatch                                      = errors.New("(ErrTypeMismatch")
	ErrIncompatibleTypesForRangeSubscripts               = errors.New("(ErrIncompatibleTypesForRangeSubscripts")
	ErrExpressionListExpected                            = errors.New("(ErrExpressionListExpected")
	ErrBooleanExpressionExpected                         = errors.New("(ErrBooleanExpressionExpected")
	ErrIntExpressionExpected                             = errors.New("(ErrIntExpressionExpected")
	ErrIntOrDecimalExpressionExpected                    = errors.New("(ErrIntOrDecimalExpressionExpected")
	ErrIntOrDecimalOrTimestampExpressionExpected         = errors.New("(ErrIntOrDecimalOrTimestampExpressionExpected")
	ErrIntOrDecimalOrTimestampOrStringExpressionExpected = errors.New("(ErrIntOrDecimalOrTimestampOrStringExpressionExpected")
	ErrStringExpressionExpected                          = errors.New("(ErrStringExpressionExpected")
	ErrSetExpressionExpected                             = errors.New("(ErrSetExpressionExpected")
	ErrTimeQuantumExpressionExpected                     = errors.New("(ErrTimeQuantumExpressionExpected")
	ErrSingleRowExpected                                 = errors.New("(ErrSingleRowExpected")

	// decimal
	ErrDecimalScaleExpected = errors.New("(ErrDecimalScaleExpected")

	ErrInvalidCast         = errors.New("(ErrInvalidCast")
	ErrInvalidTypeCoercion = errors.New("(ErrInvalidTypeCoercion")

	ErrLiteralExpected                  = errors.New("(ErrLiteralExpected")
	ErrIntegerLiteral                   = errors.New("(ErrIntegerLiteral")
	ErrStringLiteral                    = errors.New("(ErrStringLiteral")
	ErrBoolLiteral                      = errors.New("(ErrBoolLiteral")
	ErrLiteralNullNotAllowed            = errors.New("(ErrLiteralNullNotAllowed")
	ErrLiteralEmptySetNotAllowed        = errors.New("(ErrLiteralEmptySetNotAllowed")
	ErrLiteralEmptyTupleNotAllowed      = errors.New("(ErrLiteralEmptyTupleNotAllowed")
	ErrSetLiteralMustContainIntOrString = errors.New("(ErrSetLiteralMustContainIntOrString")
	ErrInvalidColumnInFilterExpression  = errors.New("(ErrInvalidColumnInFilterExpression")
	ErrInvalidTypeInFilterExpression    = errors.New("(ErrInvalidTypeInFilterExpression")

	ErrTypeAssignmentIncompatible              = errors.New("(ErrTypeAssignmentIncompatible")
	ErrTypeAssignmentToTimeQuantumIncompatible = errors.New("(ErrTypeAssignmentToTimeQuantumIncompatible")

	ErrInvalidUngroupedColumnReference         = errors.New("(ErrInvalidUngroupedColumnReference")
	ErrInvalidUngroupedColumnReferenceInHaving = errors.New("(ErrInvalidUngroupedColumnReferenceInHaving")

	ErrInvalidTimeUnit    = errors.New("(ErrInvalidTimeUnit")
	ErrInvalidTimeEpoch   = errors.New("(ErrInvalidTimeEpoch")
	ErrInvalidTimeQuantum = errors.New("(ErrInvalidTimeQuantum")
	ErrInvalidDuration    = errors.New("(ErrInvalidDuration")

	ErrInsertExprTargetCountMismatch   = errors.New("(ErrInsertExprTargetCountMismatch")
	ErrInsertMustHaveIDColumn          = errors.New("(ErrInsertMustHaveIDColumn")
	ErrInsertMustAtLeastOneNonIDColumn = errors.New("(ErrInsertMustAtLeastOneNonIDColumn")

	ErrDatabaseNotFound      = errors.New("(ErrDatabaseNotFound")
	ErrDatabaseExists        = errors.New("(ErrDatabaseExists")
	ErrInvalidDatabaseOption = errors.New("(ErrInvalidDatabaseOption")
	ErrInvalidUnitsValue     = errors.New("(ErrInvalidUnitsValue")

	ErrTableMustHaveIDColumn     = errors.New("(ErrTableMustHaveIDColumn")
	ErrTableIDColumnType         = errors.New("(ErrTableIDColumnType")
	ErrTableIDColumnConstraints  = errors.New("(ErrTableIDColumnConstraints")
	ErrTableIDColumnAlter        = errors.New("(ErrTableIDColumnAlter")
	ErrTableNotFound             = errors.New("(ErrTableNotFound")
	ErrTableExists               = errors.New("(ErrTableExists")
	ErrColumnNotFound            = errors.New("(ErrColumnNotFound")
	ErrTableColumnNotFound       = errors.New("(ErrTableColumnNotFound")
	ErrInvalidKeyPartitionsValue = errors.New("(ErrInvalidKeyPartitionsValue")

	ErrTableOrViewNotFound = errors.New("(ErrTableOrViewNotFound")

	ErrViewExists   = errors.New("(ErrViewExists")
	ErrViewNotFound = errors.New("(ErrViewNotFound")

	ErrModelExists   = errors.New("(ErrModelExists")
	ErrModelNotFound = errors.New("(ErrModelNotFound")

	ErrBadColumnConstraint         = errors.New("(ErrBadColumnConstraint")
	ErrConflictingColumnConstraint = errors.New("(ErrConflictingColumnConstraint")

	// expected errors
	ErrExpectedColumnReference         = errors.New("(ErrExpectedColumnReference")
	ErrExpectedSortExpressionReference = errors.New("(ErrExpectedSortExpressionReference")
	ErrExpectedSortableExpression      = errors.New("(ErrExpectedSortableExpression")

	// call errors
	ErrCallUnknownFunction                  = errors.New("(ErrCallUnknownFunction")
	ErrCallParameterCountMismatch           = errors.New("(ErrCallParameterCountMismatch")
	ErrIdColumnNotValidForAggregateFunction = errors.New("(ErrIdColumnNotValidForAggregateFunction")
	ErrParameterTypeMistmatch               = errors.New("(ErrParameterTypeMistmatch")
	ErrCallParameterValueInvalid            = errors.New("(ErrCallParameterValueInvalid")

	// insert errors

	ErrInsertValueOutOfRange            = errors.New("(ErrInsertValueOutOfRange")
	ErrUnexpectedTimeQuantumTupleLength = errors.New("(ErrUnexpectedTimeQuantumTupleLength")

	// bulk insert errors

	ErrReadingDatasource       = errors.New("(ErrReadingDatasource")
	ErrMappingFromDatasource   = errors.New("(ErrMappingFromDatasource")
	ErrFormatSpecifierExpected = errors.New("(ErrFormatSpecifierExpected")
	ErrInvalidFormatSpecifier  = errors.New("(ErrInvalidFormatSpecifier")
	ErrInputSpecifierExpected  = errors.New("(ErrInputSpecifierExpected")
	ErrInvalidInputSpecifier   = errors.New("(ErrInvalidInputSpecifier")
	ErrInvalidBatchSize        = errors.New("(ErrInvalidBatchSize")
	ErrTypeConversionOnMap     = errors.New("(ErrTypeConversionOnMap")
	ErrParsingJSON             = errors.New("(ErrParsingJSON")
	ErrEvaluatingJSONPathExpr  = errors.New("(ErrEvaluatingJSONPathExpr")

	// optimizer errors
	ErrAggregateNotAllowedInGroupBy = errors.New("(ErrIdPercentileNotAllowedInGroupBy")

	// function evaluation
	ErrValueOutOfRange          = errors.New("(ErrValueOutOfRange")
	ErrStringLengthMismatch     = errors.New("(ErrStringLengthMismatch")
	ErrUnexpectedTypeConversion = errors.New("(ErrUnexpectedTypeConversion")

	// time quantum function eval
	ErrQRangeFromAndToTimeCannotBeBothNull = errors.New("(ErrQRangeFromAndToTimeCannotBeBothNull")
	ErrQRangeInvalidUse                    = errors.New("(ErrQRangeInvalidUse")
	ErrInvalidDatetimePart                 = errors.New("(ErrInvalidDatetimePart")
	ErrOutputValueOutOfRange               = errors.New("(ErrOutputValueOutOfRange")
	ErrDivideByZero                        = errors.New("(ErrDivideByZero")

	// remote execution
	ErrRemoteUnauthorized = errors.New("(ErrRemoteUnauthorized")

	// query hints
	ErrUnknownQueryHint               = errors.New("(ErrInvalidQueryHint")
	ErrInvalidQueryHintParameterCount = errors.New("(ErrInvalidQueryHintParameterCount")

	// show options
	ErrUnknownShowOption = errors.New("(ErrUnknownShowOption")
)
